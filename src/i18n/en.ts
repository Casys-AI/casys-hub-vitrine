...
export const en = {
  ...
  hero: {
    ...
    cta: {
      primary: { text: "See our work", icon: "arrow_forward", url: "/use-cases" },
    ...
    authority: [
      { label: "Since 2013", detail: "KM → Graphs → AI Agents" },
    ...
    differentiation: [
      {
        ...
        icon: "timeline",
        label: "Continuity",
        title: "Context engineering since 2013",
        tagline: "Knowledge Management → Graph DB → AI agents.",
        description: "Each phase informed the next. KM shaped our graph work, graphs shaped our agent routing — expertise compounds through tech waves.",
        highlights: [
          "KM systems (2013+)",
          "Graph databases (2018+)",
          "MCP agents (2024+)",
        ],
      },
      {
        ...
        tagline: "Tools free, consulting optional.",
        description: "No vendor lock-in. We publish what we build and share the research behind it.",
        highlights: [
      ...
      },
      {
        ...
        tagline: "We ship systems that solve real problems.",
        description: "Nothing we write about is hypothetical. Every pattern is running in a production workflow before it lands in a post.",
        highlights: [
          "Running in production since 2024",
          "We use our own tools",
          "Versioned, not vaporware",
        ],
      },
      {
        id: "accessible",
        ...
        tagline: "Direct access to the people who build.",
        description: "Transparent pricing, flexible engagement, no sales funnel. Talk to the builders, not to an account manager.",
        highlights: [
          "Transparent pricing",
          "Flexible engagement",
          "Direct access to builders",
