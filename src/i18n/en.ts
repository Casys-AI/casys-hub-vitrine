...
const html = renderComposite(descriptor);`,
  ...
  mcpServerHero: {
    tagline: "TypeScript Framework for MCP",
    heroTitle1: "Ship MCP Servers",
    heroTitle2: "That Actually Scale",
    heroSubtitle:
      "Build stdio or Streamable HTTP MCP servers in TypeScript, with auth, rate limits, metrics, and middleware already wired.",
    statFeatures: "Built-in features",
    statTests: "Tests passing",
    statRelease: "Latest",
    ctaPrimary: "Start with HTTP",
  ...
  mcpStdHero: {
    ...
    heroSubtitle:
      "A standard library of MCP tools for files, git, HTTP, databases, text transforms, crypto, and UI-enabled utilities \u2014 already typed and tested.",
    statTools: "Tools",
  ...
  mcpServerComparison: {
    ...
    subtitle: "The official SDK gives you the protocol surface. This adds the operational layer around it.",
    colSdk: "Official SDK",
  ...
  mcpServerFeatures: {
    title: "What You Stop",
    titleAccent: "Hand-Rolling",
    subtitle: "Auth, quotas, validation, transport, and observability handled before your handler runs.",
    features: [
  ...
  mcpServerQuickStart: {
    title: "Start Local,",
    titleAccent: "Ship HTTP Fast",
    subtitle: "Begin with a stdio tool, then switch to authenticated Streamable HTTP without rewriting the server.",
  ...
  mcpStdCategories: {
    ...
    subtitle:
      "Start with the few categories your agent actually needs instead of wiring separate servers for common utility work.",
