...
export const zh: Translations = {
  ...
  hero: {
    ...
    cta: {
      primary: { text: "查看我们的工作", icon: "arrow_forward", url: "/use-cases" },
    ...
    authority: [
      { label: "自 2013", detail: "知识管理 → 图数据库 → AI 代理" },
    ...
    differentiation: [
      {
        ...
        tagline: "知识管理 → 图数据库 → AI 智能体。",
        description: "每一阶段都为下一阶段奠定基础。KM 塑造了我们的图谱工作，图谱塑造了智能体路由——专长跨技术浪潮持续累积。",
        highlights: [
          "KM 系统 (2013+)",
          "图数据库 (2018+)",
          "MCP 智能体 (2024+)",
      ...
      },
      {
        ...
        title: "默认开源",
        tagline: "工具免费，咨询可选。",
        description: "无供应商锁定。我们发布所构建的一切，并分享背后的研究。",
        highlights: [
          "发布于 npm 和 JSR",
          "MIT 许可",
          "无供应商锁定",
      ...
      },
      {
        ...
        title: "先研究，再生产",
        tagline: "解决真实问题的系统。",
        description: "我们写的每个方案都不是假设。每个模式在写成文章之前，都已在生产工作流中运行。",
        highlights: [
          "自 2024 年起在生产运行",
          "我们使用自己的工具",
          "已版本化，非空谈",
      ...
      },
      {
        ...
        title: "无企业级开销",
        tagline: "直接对接构建者。",
        description: "透明定价，灵活合作，无销售漏斗。你直接与构建它的人对话。",
        highlights: [
          "透明定价",
          "灵活合作",
          "直接对接构建者",
