...
export const zh_TW: Translations = {
  ...
  hero: {
    ...
    cta: {
      primary: { text: "查看我們的工作", icon: "arrow_forward", url: "/use-cases" },
    ...
    authority: [
      { label: "自 2013", detail: "知識管理 → 圖資料庫 → AI 代理" },
    ...
    differentiation: [
      {
        ...
        icon: "timeline",
        label: "持續累積",
        title: "自 2013 年深耕 Context engineering",
        tagline: "知識管理 → 圖資料庫 → AI 智能體。",
        description: "每一階段都為下一階段奠定基礎。KM 塑造了我們的圖譜工作，圖譜塑造了智能體路由——專長跨技術浪潮持續累積。",
        highlights: [
          "KM 系統 (2013+)",
          "圖資料庫 (2018+)",
          "MCP 智能體 (2024+)",
      ...
      },
      {
        ...
        title: "預設開源",
        tagline: "工具免費，諮詢可選。",
        description: "無供應商鎖定。我們發布所建構的一切，並分享背後的研究。",
        highlights: [
          "發布於 npm 與 JSR",
          "MIT 授權",
          "無供應商鎖定",
      ...
      },
      {
        ...
        title: "先研究，再生產",
        tagline: "解決真實問題的系統。",
        description: "我們寫的每個方案都不是假設。每個模式在寫成文章之前，都已在生產工作流中運行。",
        highlights: [
          "自 2024 年起於生產運行",
          "我們使用自己的工具",
          "已版本化，非空談",
      ...
      },
      {
        ...
        title: "無企業級開銷",
        tagline: "直接對接建構者。",
        description: "透明定價、彈性合作、無業務漏斗。你直接與建構它的人對話。",
        highlights: [
          "透明定價",
          "彈性合作",
          "直接對接建構者",
...
const html = renderComposite(descriptor);`,
  ...
  articleAskDialog: {
    title: "向 Erwan 提問",
    subtitleDefault: "對剛才讀到的內容有疑問？寫在這裡——24 小時內回覆。",
    subtitleWithTopic: "對 {topic} 有疑問？寫在這裡——24 小時內回覆。",
    nameLabel: "你的名字",
    namePlaceholder: "陳大明",
    emailLabel: "你的電子郵件",
    emailPlaceholder: "you@company.com",
    messageLabel: "你的問題",
    messagePlaceholder: "你卡在哪裡？想做什麼？文章裡哪裡不清楚？",
    submit: "送出",
    sending: "傳送中…",
    cancel: "取消",
    closeAria: "關閉視窗",
    success: "收到。Erwan 會在 24 小時內回覆。",
    error: "發生錯誤。請重試或寄信至 hello@casys.ai",
    hiddenSubject: "部落格提問 — {article}",
  },
