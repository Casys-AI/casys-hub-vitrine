---
title: Introduction
description: Production-grade TypeScript framework for MCP servers with auth, middleware, and dual transport.
---
...
Build MCP servers that start as local tools and grow into authenticated HTTP services without rewriting the core server.
...
<ExcalidrawDiagram src="mcp-server/mcp-architecture" alt="MCP Server Architecture" />
